...
int main(){
    ...
    Factura f1(10001,20201212,"20258555-0","Johan Shell");
    f1.ver();
    ...
    Factura f2(10010, 20201214, "18554795-3", "Silvana Regine");
    f2.ver();
    ...
    Factura f3(10011, 20201214, "11789654-2", "Mariano Rebollo");
    f3.ver();
    ...
    Factura f4(10100,20201215,"20456789-6","Leonor Valera");
    f4.ver();
    ...
    Factura f5(10101,20201215,"17452147-k","Alberto Mesa");
    f5.ver();
    ...
    Factura f6(10110, 20201216, "27123321-8", "Soledad Martos");
    f6.ver();
    ...
    Factura f7(10111, 20201217, "15963852-7", "Santos Diallo");
    f7.ver();
    ...
    Factura f8(11000, 20201218, "19456321-9", "Ona Cruz");
    f8.ver();
    ...
    Factura f9(11001, 20201219, "13741654-0", "Robert Quevedo");
    f9.ver();
    ...
    Factura f10(11010, 20201220, "22843159-4", "Agustina Medrano");
    f10.ver();
