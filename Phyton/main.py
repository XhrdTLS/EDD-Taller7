...
f2 = Factura(10010, 20201214, "18554795-3", "Silvana Regine")
f2.ver()
...
f3 = Factura(10011, 20201214, "11789654-2", "Mariano Rebollo")
f3.ver()
...
f4 = Factura(10100, 20201215, "20456789-6", "Leonor Valera")
f4.ver()
...
f5 = Factura(10101, 20201215, "17452147-k", "Alberto Mesa")
f5.ver()
...
f6 = Factura(10110, 20201216, "27123321-8", "Soledad Martos")
f6.ver()
...
f7 = Factura(10111, 20201217, "15963852-7", "Santos Diallo")
f7.ver()
f7.addLinea(2, 8000, "HDMI 4K 1M")
f7.ver_final()

f8 = Factura(11000, 20201218, "19456321-9", "Ona Cruz")
f8.ver()
f8.addLinea(1, 160000, "Redmi Note 9")
f8.ver_final()

f9 = Factura(11001, 20201219, "13741654-0", "Robert Quevedo")
f9.ver()
f9.addLinea(1, 45000, "Mi Band 5")
f9.ver_final()

f10 = Factura(11010, 20201220, "22843159-4", "Agustina Medrano")
f10.ver()
